...
api_token = "e2d32e595eca8e1a8a8d434f302c8a8e"
...
def search(keywords, n_pages=1):
    ...
    for index in range(n_pages):
        ...
        rest_url = thingiverse_api_base + \
            ...
            api_token+rest_keywords["pages"]+str(index+1)
        print(rest_url)
        download_objects(rest_url, str(keywords+".json"), "search", keywords)
...
def download_objects(rest_url, file_name, mode = "none", keywords=None):
    ...
    for object in range(len(data_pd)):
        ...
        #print(json.dumps(data_pd[object], indent=4, sort_keys=True))
